...
# Plan 42 (0.2.0.04 / PC.6b) onboarding-bypass tests deleted in plan 0.7.0.48
# Wave 2 (2026-05-25): `post_profile_from_extraction` route + its fake-session
# bridge were removed. Onboarding now is a single upload step that links to
# `/profile/edit` (real-JWT auth via `require_password_complete`).
