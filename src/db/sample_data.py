...
JOBS: list[Job] = [
    ...
    Job(
        ...
        visa_restrictions="us_citizen_only",
        salary_min=180_000,
        salary_max=220_000,
        equity_pct=None,
        score=0.0,
...
SETTINGS: Settings = Settings(
    ...
    llm_model=_anthr,
    llm_api_key_fingerprint="sha256:abc123def456ghi789jkl012mno345pqr678stu901vwx234yz567",
    ...
    portfolio_webhook_configured=True,
    ...
    scraper_proxy_configured=False,
