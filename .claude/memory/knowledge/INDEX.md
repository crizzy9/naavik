...
Static index of all knowledge entries. Dynamic index: `.claude/naavik-ops memory list knowledge`.

Aliases drive `Skill: naavik-memory-lookup` discovery. Add a new entry via:
  `.claude/naavik-ops memory record-knowledge <slug> <body-file> --aliases "a, b" --confidence H`
